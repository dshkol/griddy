...
The `listw` argument is the canonical way to pass spatial weights — using a
prebuilt row-standardized object makes the row-standardization choice explicit.
`spatial_markov()` also accepts `nb` for convenience and converts it internally
